...
- `references/closed-union-mappings.md`: Read when finite union members are mapped to values or when checking whether a proposed exhaustiveness fix catches union expansion and shrinkage.
